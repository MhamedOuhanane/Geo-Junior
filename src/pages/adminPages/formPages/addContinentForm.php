...
<head>
    ...
    <title>add continent Form</title>
</head>
<body class="flex justify-center items-center min-h-screen bg-slate-500">
    <form class="space-y-4 font-[sans-serif] max-w-md mx-auto bg-slate-300 py-10 px-10" action="../processors/add.php" method="POST">
        <span class="font-bold text-xl"> Add continent</span>
