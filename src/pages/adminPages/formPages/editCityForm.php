...
<body class="flex justify-center items-center min-h-screen bg-slate-500">
    <form class="space-y-4 font-[sans-serif] max-w-md mx-auto bg-slate-300 py-10 px-10" action="" method="POST">
        ...
        <input type="text" placeholder="name" class="px-4 py-3 bg-gray-100 w-full text-sm outline-none border-b-2 border-blue-500 rounded" value="<?= $dbcon->selectWhere("ville","id_ville",$_GET["id_ville"],"int")["nom"]; ?>" name="nom" required/>
        <input type="text" placeholder="description" class="px-4 py-3 bg-gray-100 w-full text-sm outline-none border-b-2 border-blue-500 rounded" value="" name="description" required/>
